...
#  FILES+=$(LINUX_DIR)/drivers/media/platform/sunxi-vin/modules/sensor_power/sensor_power.ko
  ...
  AUTOLOAD:=$(call AutoProbe,videobuf2-core videobuf2-dma-contig videobuf2-memops videobuf2-v4l2 vin_io imx307_mipi vin_v4l2)
endef
...
define KernelPackage/gsensor-da380
  ...
  AUTOLOAD:=$(call AutoProbe,da380,1)
endef

define KernelPackage/gsensor-da380/description
 Kernel modules for gsensor da380 support
endef
...
define KernelPackage/touchscreen-gt911
  ...
  DEPENDS:=
  FILES:=$(LINUX_DIR)/drivers/input/touchscreen/gt911/gt911_ts.ko
  AUTOLOAD:=$(call AutoProbe,gt911_ts,1)
endef
